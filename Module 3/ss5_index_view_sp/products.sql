...
drop 
  database if exists products_management;
...
delimiter // create procedure add_product(
  ...
  new_products_description varchar(50), 
...
values 
  (
    ...
    new_products_description, new_product_status
  );
end // delimiter;
...
delimiter $$ create procedure delete_product_by_id(in id_delete int) begin 
delete from 
  products 
where 
  id = id_delete;
